...
public class BubleSortGUI_2511531020 extends JFrame {
    ...
    public BubleSortGUI_2511531020() {
    ...
    private void setArrayFromInput_1020() {
        ...
        for (int k_1020 = 0; k_1020 < array_1020.length; k_1020++) {
            ...
            labelArray_1020[k_1020].setOpaque(true);
            labelArray_1020[k_1020].setBackground(Color.WHITE);
    ...
    // --- Tambahan dari foto kedua & ketiga ---
    ...
    private void resetHighlights_1020() {
        for (JLabel label : labelArray_1020) {
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(() -> {
        	BubleSortGUI_2511531020 gui_1020 = new BubleSortGUI_2511531020();
